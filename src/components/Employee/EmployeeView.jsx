...
function EmployeeView() {
    return (
        <div className='container'>
            <h1 className='border-2 border-gray-500 rounded m-2 p-2 inline-block font-Poppins'>Employee Profile</h1>
            <div className="main flex">
                ...
                <div className="w-3/5 bg-slate-400 p-3 rounded h-[650px]">
                    ...
                    <div className="info ml-4">
                        ...
                        <div className='m-3 font-Poppins'>Official Start Regularized</div>
                    </div>
                </div>
            </div>
        </div>

                    ...
                    <form autoComplete='off' className="flex" onSubmit={handleSubmit}>
                        <div className="left w-1/2 mr-4 ">
                            <div className="mb-2">
                                ...
                                <input type="text" name='id' placeholder='Type your id' onChange={handleFormData} className='font-Poppins form-control w-full' />
                            </div>
                            <div className="mb-2 row">
                                <div className="col">
                                    <label htmlFor="name" className='mb-1 font-Poppins'> First Name</label>
                                    <input type="text" name='fname' value={setFormData.fname} placeholder='Type your First Name' onChange={handleFormData} className='font-Poppins form-control' />
                                    <div className="text-red-700">{formErr.fname}</div>
                                </div>
                                <div className="col">
                                    <label htmlFor="name" className='mb-1 font-Poppins'> Last Name </label>
                                    <input type="text" name='lname' value={setFormData.lname} placeholder='Type your Last Name' onChange={handleFormData} className='font-Poppins form-control' />
                            ...
                            <div className="mb-2">
                                ...
                                <select className='font-Poppins form-select' onChange={handleFormData} name="cstatus" >
                            ...
                            <div className="mb-2 row">
                                <div className="col">
                                    ...
                                    <input type="text" name='age' placeholder='Age' onChange={handleFormData} className='font-Poppins form-control' />
                                    <div className="text-red-700">{formErr.age}</div>
                                </div>
                                <div className="col">
                                    <label htmlFor="dob" className='font-Poppins mb-1'> Date of Birth </label>
                                    <input type="date" name='dob' placeholder='DOB' onChange={handleFormData} className='font-Poppins form-control' />
                            ...
                            <div className="mb-2 row">
                                <div className="col">
                                    ...
                                    <input type="text" name='proof' placeholder='ID' onChange={handleFormData} className='font-Poppins form-control' />
                                ...
                                <div className="col">
                                    ...
                                    <input type="text" name='pob' placeholder='Place' onChange={handleFormData} className='font-Poppins form-control' />
                                    <div className="text-red-700">{formErr.pob}</div>
                                </div>
                            </div>
                            <div className="mb-2 ">
                                <label htmlFor="address" className='font-Poppins form-label mb-1'> Address</label>
                                <textarea name="address" cols="20" rows="2" onChange={handleFormData} className='font-Poppins form-control'></textarea>
                        ...
                        <div className="right w-1/2">
                            <div className="mb-2">
                                ...
                                <input type="file" name='file' onChange={handleFormData} className='font-Poppins form-control' />
                            ...
                            <div className="mb-2 row">
                                <div className="col">
                                    ...
                                    <select className='font-Poppins form-select' name="company" onChange={handleFormData} >
                                        <option selected>Choose...</option>
                                ...
                                <div className="col">
                                    ...
                                    <select className='font-Poppins form-select' onChange={handleFormData} name="department">
                                        <option selected>Choose...</option>
                            ...
                            <div className="mb-2">
                                ...
                                <select className='font-Poppins form-select' onChange={handleFormData} name="jobtitle">
                                    <option selected>Choose...</option>
                            ...
                            <div className="mb-2">
                                ...
                                <input type="email" name='cpemail' placeholder='Type your email' onChange={handleFormData} className='font-Poppins form-control' />
                            ...
                            <div className="mb-3">
                                ...
                                <select className='font-Poppins form-select' onChange={handleFormData} name="lvgroup">
                                    <option selected>Choose...</option>
                            ...
                            <div className="mb-2 row">
                                <div className="col">
                                    ...
                                    <select className='font-Poppins form-select' onChange={handleFormData} name="empType">
                                        <option selected>Choose...</option>
                                ...
                                <div className="col">
                                    ...
                                    <select className='font-Poppins form-select' onChange={handleFormData} name="empStatus">
                                        <option selected>Choose...</option>
                            ...
                            <div className="mb-3 row">
                                <div className="col">
                                    <label htmlFor="date" className='font-Poppins form-label mb-1'> Official Start Date </label>
                                    <input type="date" name='srtdate' placeholder='Start Date' onChange={handleFormData} className='font-Poppins form-control' />
                                    <div className="text-red-700">{formErr.srtdate}</div>
                                </div>
                                <div className="col">
                                    <label htmlFor="date" className='font-Poppins form-label mb-1'> Date Regularized</label>
                                    <input type="date" name='regdate' placeholder='Regularized Date' onChange={handleFormData} className='font-Poppins form-control' />
